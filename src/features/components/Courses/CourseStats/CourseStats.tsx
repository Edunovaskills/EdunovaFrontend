...
const CourseStats = () => {
  ...
  return (
    <StatsContainer>
      ...
      <FloatingElement $position="bottom: 15%; right: 8%;" $size="12rem" $delay="1s" />
      <FloatingElement $position="top: 60%; left: 15%;" $size="6rem" $delay="0.5s" />
      <FloatingElement $position="top: 20%; right: 20%;" $size="10rem" $delay="1.5s" />
      ...
      <StatsWrapper>
        <SectionHeader>
          ...
          <SectionDescription>
            ...
            through our comprehensive courses and expert guidance.
          </SectionDescription>
        </SectionHeader>
